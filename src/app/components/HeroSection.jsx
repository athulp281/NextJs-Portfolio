            ...
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    ...
                    <div>
                        ...
                        <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple to-secondary-500 hover:bg-slate-800 text-white  mt-3">
